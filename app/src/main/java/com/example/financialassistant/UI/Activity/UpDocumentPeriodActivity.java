...
public class UpDocumentPeriodActivity extends AppCompatActivity {
    Long document;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rDate = sdf.format(modelDocument.repeat_date);
        replayDate.setText(rDate);

        name_document.setText(modelDocument.name);

        idperiod = modelDocument.id_period;
        getIdPeriod(documentPeriodModels);
        ...
        int index2 = strings.indexOf(nameperiod);
            ...
            replayDate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (count_click_2 == 0) {
                        ...
                        date_replay.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
    ...
    private void getIdPeriod(List<DocumentPeriod> documentPeriodModels){
        for (DocumentPeriod c: documentPeriodModels){
