...
import com.example.financialassistant.UI.Activity.adapter.SomeStatisticsCostRecyclerAdapter;
...
public class StatisticsCostActivity extends AppCompatActivity/* implements SomeCostRecyclerAdapter.OnDeleteListener*/ {
    ...
    public void period() {
        if (flag == true)
        {
            SomeStatisticsCostRecyclerAdapter recyclerAdapter = new SomeStatisticsCostRecyclerAdapter(this, databaseHelper.getCostDao().getCostByMonthOrWeekFromCategory(timeMilliStart, timeMilliFinish, idcategory));
            // recyclerAdapter.setOnDeleteListener(this);
            recyclerView.setAdapter(recyclerAdapter);
            summa = databaseHelper.getCostDao().getSumByMonthOrWeekFromCategory(timeMilliStart, timeMilliFinish, idcategory);
            String str = String.valueOf(summa);
            sum.setText(str);
            recyclerView.setVisibility(View.VISIBLE);
        }
        else {
            SomeStatisticsCostRecyclerAdapter recyclerAdapter = new SomeStatisticsCostRecyclerAdapter(this, databaseHelper.getCostDao().getCostByMonthOrWeek(timeMilliStart, timeMilliFinish));
            //  recyclerAdapter.setOnDeleteListener(this);
            recyclerView.setAdapter(recyclerAdapter);
            summa = databaseHelper.getCostDao().getSumAllByMonthOrWeek(timeMilliStart, timeMilliFinish);
            String str = String.valueOf(summa);
            sum.setText(str);
            recyclerView.setVisibility(View.VISIBLE);
        }
