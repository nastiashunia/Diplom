...
import com.example.financialassistant.UI.Activity.adapter.SomeCostCategoryRecyclerAdapter;
import com.example.myroom1.R;

import butterknife.BindView;
import butterknife.ButterKnife;

public class CategoryCostActivity extends AppCompatActivity implements SomeCostCategoryRecyclerAdapter.OnClickListener {

    @BindView(R.id.recyclerView)
    RecyclerView recyclerView;

    SomeCostCategoryRecyclerAdapter recyclerAdapter;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_add: {
                int operation = 0;
                Intent intent1 = new Intent(this, AddUpCategoryCostActivity.class);
    ...
    protected void onResume() {
        ...
        recyclerAdapter = new SomeCostCategoryRecyclerAdapter(this, databaseHelper.getCategoryCostDao().getAllCategoryCost());
    ...
    @Override
    public void onDelete(CategoryCost categoryModel) {
        ...
        alert.setPositiveButton(yes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                databaseHelper.getCategoryCostDao().deleteCategoryCost(categoryModel);
    ...
    @Override
    public void onUp(CategoryCost categoryModel) {
